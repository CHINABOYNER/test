...
public class One {
    ...
    @GetMapping
    public void downloadOne(HttpServletResponse httpServletResponse) throws IOException {
        Date today = new Date();
    ...
    @PostMapping
    public Result showOne(@RequestHeader(value = "token", required = false) String token) {
        if(null == token) {
